...
public class ChartController {
   ...
   public ChartDTO retrieveChart(@PathVariable("id") String id) {
    ...
    @PutMapping("/associateChartWithDatasource/{chartId}/{datasourceId}")
    public ResponseEntity<String> associateChartWithDatasource(
            @PathVariable("chartId") String chartId,
            @PathVariable("datasourceId") String datasourceId) {

        chartService.associateChartWithDatasource(chartId, datasourceId);
        return ResponseEntity.ok("Association successful");
    }



/*
    @PutMapping("/disassociateChartFromDatasource/{chartId}")
    public ResponseEntity<String> disassociateChartFromDatasource(
            @PathVariable("chartId") String chartId) {

        chartService.disassociateChartFromDatasource(chartId);
        return ResponseEntity.ok("Disassociation successful");
    }
*/
}
